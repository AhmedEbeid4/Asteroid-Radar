...
fun getImage(jsonResult: JSONObject): PictureOfDay? {
    ...
    return PictureOfDay(date, explanation, title, url)
}

fun parseAsteroidsJson(jsonResult: JSONObject): ArrayList<Asteroid> {
